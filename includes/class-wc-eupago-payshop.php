...
* @since 0.1
*/
if ( !class_exists( 'WC_EuPago_PayShop_WebAtual' ) ) {
  class WC_EuPago_PayShop_WebAtual extends WC_Payment_Gateway {
    ...
    function init_form_fields() {
      $this->form_fields = array(
        'enabled' => array(
          ...
          'type' => 'checkbox',
          'label' => __( 'Enable PayShop (using euPago)', 'eupago-gateway-for-woocommerce'),
          'default' => 'no'
        ),
        'title' => array(
          ...
          'default' => __('PayShop', 'eupago-gateway-for-woocommerce')
        ),
        'description' => array(
          ...
          'default' => __('Pay at PayShop agent', 'eupago-gateway-for-woocommerce')
        ),
        'instructions' => array(
    ...
    public function thankyou_page( $order_id ) {
      ...
      if ( $payment_method == $this->id ) {
        ...
        wc_get_template( 'payment-instructions.php', array(
          ...
          'referencia' => get_post_meta($order_id, '_eupago_payshop_referencia', true),
