...
* @since 2.0
*/
if ( !class_exists( 'WC_EuPago_PF_WebAtual' ) ) {
  class WC_EuPago_PF_WebAtual extends WC_Payment_Gateway {
    ...
    public function thankyou_page( $order_id ) {
      ...
      if ( $payment_method == $this->id ) {
        ...
        wc_get_template( 'payment-instructions.php', array(
          ...
          'referencia' => get_post_meta($order_id, '_eupago_pf_referencia', true),
